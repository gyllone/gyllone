# Lone Ge · Blockchain & Quant Engineer

I build high-performance systems at the intersection of **blockchain infrastructure**, **zero-knowledge cryptography**, and **quantitative trading**. My work spans SVM and EVM ecosystems, privacy-preserving protocols, DeFi primitives, and production trading systems.
...
| Area | Technologies |
| --- | --- |
| Languages | Rust, Go, Python, Solidity, Move, Tact, TypeScript, C/C++, CUDA |
| Blockchains | EVM, SVM/Solana, Sui, TON, OP Stack, Filecoin |
...
[![GitHub](https://img.shields.io/badge/GitHub-gyllone-181717?style=flat&logo=github&logoColor=white)](https://github.com/gyllone)
